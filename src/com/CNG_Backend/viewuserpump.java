...
/**
 * Servlet implementation class viewuserpump
 */
public class viewuserpump extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
            ...
            request.getRequestDispatcher("viewuserpumps.jsp").forward(request, response);
